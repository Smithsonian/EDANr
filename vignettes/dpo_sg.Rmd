---
title: "Searching for Images from DPO Mass Digitization Project"
author: "Luis J. Villanueva"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Searching for Images from DPO Mass Digitization Project}
...
Add the AppID and AppKey, load packages, other misc steps:
...
#Query EDAN to get number of results
...
#Store number of results in EDAN
...
#Filter for images that were taken by the contractor
...
Get the info to write to the image:
...
#If title is too long, break in two lines
...
if (img_info$width > img_info$height){
  ...
  image_write(img_ready, path = localimage_v, format = "jpg")
}
